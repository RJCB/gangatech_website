...
import logoBlack from "../images/logo_gtech.svg";
...
const Homepage = () => {
  ...
  return (
    <>
        ...
        <div className="about-us-summary">
          <div className="left-side">
            <p className="left-text">
              <span>
                <strong className="welcome">Welcome to Ganga Tech</strong>, a
          ...
          <div className="right-side">
            ...
            <p className="right-text">
              <span>
                ...
                professionals, Ganga Tech is your trusted partner for navigating
      ...
      <footer>&copy; 2024 Ganga Tech Inc. All rights reserved.</footer>
    </>
  );
};
